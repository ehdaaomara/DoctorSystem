...
export default class MedicineDoc extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            advice: "",
            ...
            <>
                <View style={{ backgroundColor: "#ffff", flex: 1 }}>
                    <View style={{
                        ...
                        <Text style={{ color: "#ffff", marginLeft: width * 0.12, fontSize: 22, fontWeight: "bold", marginTop: height * 0.015 }}>Medication and timing</Text>
                    ...
                    <ScrollView>
                       ...
                       <Text style={{textAlign:"center",fontSize:20, color: "#8f8f8f"}}>registered anything yet</Text> */}
                        ...
                        <TextInput style={{ padding: 10, height: height * 0.15, width: width * 0.85, alignSelf: "center", fontSize: 18, color: "#37474f", borderWidth: 1, borderColor: "#8f8f8f", borderRadius: 10 }}
                            ...
                            placeholder={"Write the medication and timing :"}
