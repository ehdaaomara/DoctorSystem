...
export default class TestsDoc extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            advice: "",
        ...
        return (
            <>
                ...
                <View style={{
                            ...
                            <Text style={{ color: "#ffff", marginLeft: width * 0.13, fontSize: 22, fontWeight: "bold",marginTop:height*0.015 }}>Medical tests & results</Text>
                    ...
                    <TextInput style={{ padding: 10, height: height * 0.15, width: width * 0.85, alignSelf: "center", fontSize: 18, color: "#37474f", borderWidth: 1, borderColor: "#8f8f8f", borderRadius: 10 }}
                            ...
                            placeholder={"Write the medical tests and their results :"}
