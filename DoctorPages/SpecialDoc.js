...
export default class SpecialDoc extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            advice: "",
        ...
        return (
            <>
                ...
                <View style={{
                            ...
                            <Text style={{ color: "#ffff", marginLeft: width * 0.06, fontSize: 22, fontWeight: "bold",marginTop:height*0.015 }}>patient's cases & diseases</Text>
                    ...
                    <TextInput style={{ padding: 10, height: height * 0.15, width: width * 0.85, alignSelf: "center", fontSize: 18, color: "#37474f", borderWidth: 1, borderColor: "#8f8f8f", borderRadius: 10 }}
                            ...
                            placeholder={"Write the patient's condition and health :"}
