...
export default class SpecialCases extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
        ...
        return (
            <>
                ...
                <View style={{
                            ...
                            <Text style={{ color: "#ffff", marginLeft: width * 0.1, fontSize: 22, fontWeight: "bold",marginTop:height*0.015 }}>Your cases & diseases</Text>
