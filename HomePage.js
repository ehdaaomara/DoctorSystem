...
export default class HomePage extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            name:this.props.navigation.getParam("input_user"),
                            ...
                            <ScrollView>
                                ...
                                >
                                    ...
                                    <View >
                                        ...
                                        <Text style={{ fontSize: 18, fontWeight: "bold", color: "#37474f" }}>        your health</Text>
                                ...
                                onPress={() => {
                                    this.props.navigation.navigate("page_24")
                                    // this.sendData()
                                }}
                                >
                                    ...
                                    />
                                    <View >
                                        <Text style={{ fontSize: 18, marginTop: height * 0.07, fontWeight: "bold", color: "#37474f" }}>     Your doctor's  </Text>
                                        <Text style={{ fontSize: 18, fontWeight: "bold", color: "#37474f" }}>     advice to you</Text>
                                    </View>
                                ...
                                onPress={() => {
                                    this.props.navigation.navigate("page_25")
                                    // this.sendData()
                                }}
                                >
                                ...
                                onPress={() => {
                                    this.props.navigation.navigate("page_28")
                                    // this.sendData()
                                }}
                                >
                                ...
                                onPress={() => {
                                    this.props.navigation.navigate("page_26")
                                    // this.sendData()
                                }}
                                >
                                ...
                                onPress={() => {
                                    this.props.navigation.navigate("page_27")
                                    // this.sendData()
                                }}
                                >
